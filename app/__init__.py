...
def create_app(config_class=Config):
    ...
    from .routes.publicationRoutes import publicationRoutes
    app.register_blueprint(publicationRoutes)

    from .routes.projectRoutes import projectRoutes
    app.register_blueprint(projectRoutes)

    from .routes.cmsRoutes import cmsRoutes
    app.register_blueprint(cmsRoutes)

    from .routes.memberRoutes import memberRoutes
    app.register_blueprint(memberRoutes)

    from .routes.galleryRoutes import galleryRoutes
    app.register_blueprint(galleryRoutes)

    from .routes.menuRoutes import menuRoutes
    app.register_blueprint(menuRoutes)

    from .routes.commentRoutes import commentRoutes
    app.register_blueprint(commentRoutes)
    ...
    from .routes.publicRoutes import publicRoutes
